...
2️⃣ Ensure you have Python installed on your system.

Running the Game:
1️⃣ Open the terminal or command prompt in the project directory.
2️⃣ Run the following command: python snake.py
3️⃣ The game window will open, and you can start playing immediately!
